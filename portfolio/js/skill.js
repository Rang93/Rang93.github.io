      ...
      return _right.animate({
        ...
        complete() {
          ...
          _left.css({
			...
			if( $(this).prev().text() == 'Ps' ){
				$(this).css({background:'#2d4299'})
				_left.css({background:'#2d4299'})
		   } else if( $(this).prev().text() == 'Ai' ){
				$(this).css({background:'#e37c39'})
			   _left.css({background:'#e37c39'})
		   } else {
			   $(this).css({background:'#e7282c'})
			   _left.css({background:'#e7282c'})
		   }
